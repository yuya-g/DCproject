...
plt.plot(train_data['ds'], train_data['y'], label='After Interpolation', color='blue')
plt.scatter(outliers['ds'], outliers['y'], color='red', label='Outliers (Before)', alpha=0.6)
plt.legend()
plt.show()
